...
class Ra_Admin{
  ...
  public function ra_admin_menu() {
    add_menu_page( $page_title = 'Alike - Compare WP Post', $menu_title = 'Alike', $capability = 'manage_options', $menu_slug = 'alike_admin', $function =  array( $this , 'ra_admin_main_menu_options'),$icon_url = 'dashicons-vault' );
