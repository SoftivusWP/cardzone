 ...
 *
 */
// use Reuse\Builder\Reuse_Builder_ICONS_Provider;
class Reuse_Builder_Reuse {

  public static function load($localPath) {
    $reuseform_scripts = json_decode(file_get_contents( RA_DIR . "/resource/reuse.json"),true);
    ...
    wp_localize_script( 'reuse-builder-js', 'REUSE_ADMIN', array(
      ...
      'base_url'              => apply_filters( 'reuse_image_base_url',  RA_DIR ),
    ));
  }
