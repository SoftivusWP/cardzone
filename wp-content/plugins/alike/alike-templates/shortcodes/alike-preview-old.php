...
foreach ($new_all_data['on_top'] as $key => $value) {
  _log($key);
  _log($value);
  // $new_combined_top[$value['id']][$key] = $value['data'];
}
...
_log($new_combined_bottom);
_log($new_combined_top);
//----------------------------
// TEST WITH NEW CODE
//----------------------------
            ...
            <tr>
                ...
                <th>
                    ...
                    <div class="alike-table-top-bar">
                        <h2>
                          <a href="<?php echo esc_url( get_the_permalink( $id ) ); ?>"><?php echo apply_filters('the_title', get_the_title( $id ), $id ); ?></a>
                        </h2>
