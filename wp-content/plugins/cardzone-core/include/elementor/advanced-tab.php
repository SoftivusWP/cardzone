...
?>
<section class="tp-project-area-2 pt-120 ele-section tp-el-section">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-4">
                <div class="tp-project-title-wrapper-2 mb-60">
                    ...
                    <span class="tp-section-title-pre">
                        <?php echo tp_kses($settings['tp_section_sub_title']); ?></span>
                    <?php endif; ?>
                    <?php
            ...
            <div class="col-lg-8">
                <div class="tp-project-tab-wrapper tab-wrapper-2 d-flex justify-content-end wow fadeInRight"
                    ...
                    <ul class="nav nav-pills" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link <?php echo esc_attr($active); ?>"
                                ...
                                aria-selected="true"><?php echo tp_kses($tab['title']); ?></button>
                        </li>
                        <?php endforeach; ?>
                    </ul>
                </div>
...
?>
<!-- project area start -->
<section class="tp-project-area-3 pt-120 pb-90 tp-el-section">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-12">
                <div class="tp-project-title-wrapper-3 text-center mb-30">
                    <?php if ( !empty($settings['tp_section_sub_title']) ) : ?>
                    <span class="tp-section-title-pre">
                        <?php echo tp_kses($settings['tp_section_sub_title']); ?></span>
                    <?php endif; ?>
...
<section class="tp-project-area pb-95 ele-section tp-el-section">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
