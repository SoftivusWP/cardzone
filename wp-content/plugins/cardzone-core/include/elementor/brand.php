...
<div class="tp-brand-3-area breadcrumb-brand p-relative pt-65 pb-60 tp-el-section">
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
...
<?php else :
if ( !empty($settings['tp_brand_bg_image']['url']) ) {
    $tp_brand_bg_image_url = !empty($settings['tp_brand_bg_image']['id']) ? wp_get_attachment_image_url( $settings['tp_brand_bg_image']['id'], $settings['thumbnail_size']) : $settings['tp_brand_bg_image']['url'];
    $tp_brand_bg_image_alt = get_post_meta($settings["tp_brand_bg_image"]["id"], "_wp_attachment_image_alt", true);
}
?>
<!-- brand area start -->
<div class="tp-brand-area tp-brand-background-no p-relative pb-120 tp-el-section">
    <div class="container">
        <div class="tp-brand-wrapper p-relative wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s"
        style="background-image:url(<?php echo esc_url($tp_brand_bg_image_url); ?>)">
            <div class="row">
                <?php foreach ($settings['tp_brand_slides'] as $item) :
                    if ( !empty($item['tp_brand_image']['url']) ) {
                        $tp_brand_image_url = !empty($item['tp_brand_image']['id']) ? wp_get_attachment_image_url( $item['tp_brand_image']['id'], $settings['thumbnail_size']) : $item['tp_brand_image']['url'];
