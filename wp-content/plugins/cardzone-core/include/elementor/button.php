...
class TP_Button extends Widget_Base {
	...
	protected function register_controls_section() {
        ...
        $this->add_control(
            'tp_btn_image',
            [
                'label' => esc_html__('Button Image', 'tpcore'),
...
<?php if ( $settings['tp_design_style']  == 'layout-2' ): 
    ...
    $tp_btn_image_url = !empty($settings['tp_btn_image']['id']) ? wp_get_attachment_image_url( $settings['tp_btn_image']['id'], $settings['thumbnail_size_size']) : $settings['tp_btn_image']['url'];
...
<div class="app__store d-flex align-items-center gap-3 flex-wrap wow fadeInDown">
    <a <?php echo $this->get_render_attribute_string( 'tp-button-arg' ); ?>>
        <img src="<?php echo ($tp_btn_image_url); ?>" alt="">
    </a>
</div>
...
<?php else: 
    ...
    if ('2' == $settings['tp_btn_link_type']) {
        ...
        $this->add_render_attribute('tp-button-arg', 'target', '_self');
        $this->add_render_attribute('tp-button-arg', 'rel', 'nofollow');
        $this->add_render_attribute('tp-button-arg', 'class', "cmn--btn main-btn tp-el-btn ");
    } else {
        $this->add_render_attribute('tp-button-arg', 'class', "cmn--btn main-btn tp-el-btn ");
        if ( ! empty( $settings['tp_btn_link']['url'] ) ) {
            $this->add_link_attributes( 'tp-button-arg', $settings['tp_btn_link'] );
