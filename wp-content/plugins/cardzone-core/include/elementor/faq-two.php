 ...
 * @since 1.0.0
 */
class TP_FAQ_TWO extends Widget_Base {
...
<div class="accordion__wrap">
    <div class="accordion" id="accordionExample">
        ...
        <div class="accordion-item wow fadeInDown" data-wow-duration="0.7s">
            <h2 class="accordion-header" id="heading-<?php echo esc_attr($var); ?>">
                <button class="accordion-button <?php echo esc_attr($collapsed); ?>" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-<?php echo esc_attr($var); ?>" aria-expanded="<?php echo $is_active ? 'true' : 'false'; ?>" aria-controls="collapse-<?php echo esc_attr($var); ?>">
                    <?php echo esc_html($item['accordion_title']); ?>
                </button>
            </h2>
            <div id="collapse-<?php echo esc_attr($var); ?>" class="accordion-collapse collapse <?php echo esc_attr($show); ?>" aria-labelledby="heading-<?php echo esc_attr($var); ?>" data-bs-parent="#accordionExample">
...
$widgets_manager->register( new TP_FAQ_TWO() );