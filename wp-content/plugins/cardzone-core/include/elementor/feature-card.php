 ...
 * @since 1.0.0
 */
class TP_Feature_Card extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'apply-button-text',
            [
                'label' => esc_html__('Apply Button Text', 'finview-core'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Apply Now', 'finview-core'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
			'apply-button-url',
			[
				'label' => esc_html__( 'Apply Button URL', 'cardzone-core' ),
				'type' => \Elementor\Controls_Manager::URL,
				'options' => [ 'url', 'is_external', 'nofollow' ],
				'default' => [
					'url' => '',
      ...
      <div class="row justify-content-center g-4">
        ...
        ?>
         ...
         <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
            <div class="top__items round16 bgwhite">
               <div class="icon m-auto d-flex align-items-center icolor1 justify-content-center round50">
               ...
               <div class="content text-center mt-24">
                 <h3 class="mb-16">
                  ...
                  <a href="<?php echo the_permalink(); ?>" class="arrow m-auto boxes4 round50 d-flex align-items-center justify-content-center">
         ...
         <?php
            ...
            if ($query->max_num_pages > 1) {
                ...
                if (get_previous_posts_link()) {
                    ...
                    previous_posts_link('<i class="material-symbols-outlined">
                    chevron_left
                 </i>');
                    echo '</li>';
                }
                ...
                if (get_next_posts_link()) {
                    echo '<li class="page-item">';
                    next_posts_link('<i class="material-symbols-outlined">
                    chevron_right
                 </i>');
                    echo '</li>';
                }
...
<section class="card__details__section d-none card-listing-archive ralt">
   <div class="container">
      <div class="row">
         <div class="col-xl-12">
                  ...
                  <div class="popular__items popular__v2 round16">
                     ...
                     <?php the_post_thumbnail(); ?>
                        ...
                        <div class="d-flex flex-wrap gap-4 align-items-center">
                           <a href="<?php echo tp_kses($settings['contact_btn_url']); ?>" class="compare__btn d-flex align-items-center">
                                ...
                                <span class="fz-14 fw-400 inter ">
                                    <?php echo tp_kses($settings['contact_btn_text']); ?>
                                </span>
                           </a>
                     ...
                     <div class="card__boxright">
                        <div class="d-flex mb-30 justify-content-between align-items-center justify-content-between flex-wrap gap-3">
                           ...
                           <?php if ( !empty($settings['apply-button-text']) ) : ?>
                                <a href="<?php echo tp_kses($settings['apply-button-text']); ?>" class="cmn--btn">
                                    <span>
...
$widgets_manager->register(new TP_Feature_Card());
