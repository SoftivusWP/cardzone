 ...
 * @since 1.0.0
 */
class TP_FiltertwoBox extends Widget_Base
{
    ...
    {
        return __('Filter Box Two', 'cardzone');
    }
                            ...
                            <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-6 col-sm-6">
                                <div class="card__find__item">
                                    <span class="fz-18 fw-500 inter title mb-16 d-block">
                                        <?php echo esc_html__('What\'s your credit score?', 'tpcore'); ?>
                                    </span>
                            ...
                            <div class="col-xxl-2 col-xl-2 col-lg-3 col-md-4 col-sm-5">
                                <div class="card__find__item">
                                    <button type="submit" class="cmn--btn">
                                        <span><?php echo esc_html__('Find Your Card', 'tpcore'); ?></span>
                                    </button>
                                </div>
                            </div>
                        </div>
...
$widgets_manager->register(new TP_FiltertwoBox());
