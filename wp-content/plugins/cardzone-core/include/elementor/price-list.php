 ...
 * @since 1.0.0
 */
class TP_Price_List extends Widget_Base {
    ...
    protected function register_controls_section(){
		...
		'tp_text_list_title',
		  [
			'label'   => esc_html__( 'Title', 'tpcore' ),
			'type'        => \Elementor\Controls_Manager::TEXT,
			'default'     => esc_html__( 'Max credit', 'tpcore' ),
			'label_block' => true,
		  ]
		);
		...
		'tp_text_list_price',
		  [
			...
			'type'        => \Elementor\Controls_Manager::TEXT,
			'default'     => esc_html__( '$150,000', 'tpcore' ),
			'label_block' => true,
		  ]
		);
			...
			<?php foreach ($settings['tp_text_list_list'] as $key => $item) : ?>
				<li class="d-flex align-items-center justify-content-between">
					...
					<span class="fz-14 fw-400 inter title">
						<?php echo tp_kses($item['tp_text_list_price']); ?>
					</span>
				</li>
			<?php endforeach ?>
		</ul>
...
$widgets_manager->register( new TP_Price_List() ); 