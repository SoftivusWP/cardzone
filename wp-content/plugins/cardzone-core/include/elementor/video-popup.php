...
class TP_Video_Popup extends Widget_Base {
    ...
    protected function style_tab_content(){
        ...
        $this->tp_link_controls_style('section_btn', 'Video - Button', '.tp-el-btn');
    }
...
<!-- team area 2 start -->
<div class="tp-team-video-area tp-team-video-bg tp-el-section">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="tp-team-video-wrapper wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                    ...
                    <div class="tp-play-btn">
                        <a class="play-btn popup-video tp-el-btn" href="<?php echo esc_url($settings['tp_video_url']); ?>"><i
