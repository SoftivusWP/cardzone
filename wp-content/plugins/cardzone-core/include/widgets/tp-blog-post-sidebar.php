...
Class TP_Post_Sidebar_Widget extends WP_Widget{
	...
	public function __construct(){
		parent::__construct('rs-latest-posts', 'TP Sidebar Posts Image', array(
...
<div class="rs-sidebar-widget-content">
    ...
    <div class="rs-sidebar-post rs-rc__post">
        <div class="rs-rc__post d-flex align-items-center">
            <?php if ( has_post_thumbnail() ): ?>
            <div class="rs-rc__post-thumb mr-25">
                <a href="<?php the_permalink(); ?>"><?php the_post_thumbnail('thumbnail'); ?></a>
            </div>
            <?php endif; ?>

            <div class="rs-rc__post-content">
                <h3 class="rs-rc__post-title">
                    <a href="<?php the_permalink(); ?>"><?php print wp_trim_words(get_the_title(), 7, ''); ?></a>
                </h3>
                <div class="rs-rc__post-meta">
...
<?php
	...
	public function form($instance){
		...
		$count = ! empty( $instance['count'] ) ? $instance['count'] : esc_html__( '3', 'cardzonecore' );
		$posts_order = ! empty( $instance['posts_order'] ) ? $instance['posts_order'] : esc_html__( 'DESC', 'cardzonecore' );
		$choose_style = ! empty( $instance['choose_style'] ) ? $instance['choose_style'] : esc_html__( 'style_1', 'cardzonecore' );
	?>
<p>
