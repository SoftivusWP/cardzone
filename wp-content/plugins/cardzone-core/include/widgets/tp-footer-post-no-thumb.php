...
Class TP_Latest_Post_Footer_No_Thumb extends WP_Widget{
	...
	public function __construct(){
		parent::__construct('tp-latest-posts-footer-no-thumb', 'Finbest Footer Posts No Thumb', array(
			'description'	=> 'Latest Post Widget by Finbest'
		));
	}
...
<div class="tp-footer-widget-content">
    ...
    <div class="tp-footer-widget-item">
        <h4 class="tp-footer-widget-item-title"> <a
