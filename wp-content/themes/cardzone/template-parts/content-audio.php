...
$cardzone_audio_url = function_exists( 'tpmeta_field' ) ? tpmeta_field( 'cardzone_post_audio' ) : NULL;
...
?>
 ...
 <article id="post-<?php the_ID();?>" <?php post_class( 'postbox__item tp-postbox-item-wrapper rs-postbox-item  bgwhite mb-24 p-8 round16 blog__content mb-80 format-image' );?>>
     <?php if ( has_post_thumbnail() ): ?>
     <div class="tp-postbox-item-thumb p-relative mb-25">
     <?php echo wp_oembed_get( $cardzone_audio_url ); ?>
     </div>
     <?php endif; ?>
     <!-- blog meta -->
...
<article id="post-<?php the_ID();?>" <?php post_class( 'tp-postbox-item mb-50 rs-postbox-item blog__content bgwhite mb-24 p-8 round16 format-audio' );?>>
    <?php if ( has_post_thumbnail() ): ?>
