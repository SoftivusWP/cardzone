 ...
 */
 ...
 $cardzone_video_url = function_exists('tpmeta_field')? tpmeta_field('cardzone_post_video') : '';
...
<article id="post-<?php the_ID();?>" <?php post_class( 'postbox__item tp-postbox-item-wrapper rs-postbox-item blog__content bgwhite mb-24 p-8 round16 mb-80 format-image' );?>>
    <?php if ( has_post_thumbnail() ): ?>
    <div class="tp-postbox-thumb p-relative mb-25">
        <a href="<?php the_permalink();?>">
            <?php the_post_thumbnail( 'full', ['class' => 'img-responsive'] );?>
        </a>
        <?php if ( !empty($cardzone_video_url) ): ?>
        <div class="tp-postbox-thumb-btn">
            <a class="play-btn popup-video" href="<?php echo esc_url($cardzone_video_url); ?>"><i
...
<?php else: ?>
<article id="post-<?php the_ID();?>" <?php post_class( 'tp-postbox-item mb-50 rs-postbox-item blog__content bgwhite mb-24 p-8 round16 format-video' );?>>
    <?php if ( has_post_thumbnail() ): ?>
